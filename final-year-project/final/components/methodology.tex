...
\begin{enumerate}
	...
	\item Sprint - all development work is carried out here. There are daily stand ups which involved the developer taking into account the work achieved the previous day, what was going to be achieved today and also any difficulties encountered. While this project was a lone developer project it was still constructive as it forced consideration of the Jira board and also helped guide the day to day work.
	...
	\item Sprint Retrospective - A retrospective will then analyse \gls{sprint} performance and help to highlight areas where improvement can be made. This will also enhance the accuracy of the following \gls{sprint}.
\end{enumerate}
